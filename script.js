...
// --- CONFIGURAÇÃO SUPABASE ---
const API_URL = "https://dpbeautygestao.com.br/.com/api"; // ← Ajuste
      ...
      if (targetElement) {
        ...
        setTimeout(
          () => {
            ...
            let finalOffset =
              elementPosition - navHeight + (isMobileMenuOpen ? 420 : 2);
  ...
  if (ebookForm) {
    ebookForm.addEventListener("submit", async function (e) {
      ...
      try {
        ...
        alert(
          'Erro ao salvar dados. Verifique sua conexão ou se a tabela "leads" existe no Supabase.',
        );
